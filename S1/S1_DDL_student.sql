...
ALTER TABLE IF EXISTS medewerkers
    ADD geslacht char(1) constraint m_geslacht_chk
...
INSERT INTO afdelingen VALUES (50, 'ONDERZOEK', 'ZWOLLE', null);
INSERT INTO medewerkers VALUES (8000, 'DONK', 'A', 'ONDERZOEK', 7839, date('1980-10-10'), 3000, null, 50, 'M');
...
ALTER TABLE afdelingen ALTER COLUMN anr SET DEFAULT nextval('afdelingen_seq');
INSERT INTO afdelingen (naam, locatie, hoofd) VALUES ('A', 'UTRECHT', null);
INSERT INTO afdelingen (naam, locatie, hoofd) VALUES ('B', 'UTRECHT', null);
INSERT INTO afdelingen (naam, locatie, hoofd) VALUES ('C', 'UTRECHT', null);
INSERT INTO afdelingen (naam, locatie, hoofd) VALUES ('D', 'UTRECHT', null);
INSERT INTO afdelingen (naam, locatie, hoofd) VALUES ('E', 'UTRECHT', null);

ALTER TABLE afdelingen ALTER COLUMN anr SET DATA TYPE numeric(100);
ALTER TABLE afdelingen ALTER COLUMN anr DROP DEFAULT;
DROP SEQUENCE IF EXISTS afdelingen_seq;
...
CREATE TABLE adressen (
    postcode varchar(6) CONSTRAINT p_check CHECK ( postcode ~('[0-9][0-9][0-9][0-9][A-Z][A-Z]') ),
    huisnummer varchar(10),
    ingangsdatum date,
    einddatum date CONSTRAINT einddatum_chk CHECK ( einddatum > adressen.ingangsdatum ),
    telefoon numeric(10) UNIQUE,
    med_mnr numeric(10)
        CONSTRAINT med_mnr_nn NOT NULL
        CONSTRAINT med_mnr_fk REFERENCES medewerkers DEFERRABLE,
    CONSTRAINT pk PRIMARY KEY (postcode, huisnummer, ingangsdatum)
);

INSERT INTO adressen values('1234AA', '2', '11-09-2022', '12-09-2022', 0637221769, 8000);
...
ALTER TABLE medewerkers DROP CONSTRAINT IF EXISTS comm_chk;
ALTER TABLE medewerkers add CONSTRAINT comm_chk CHECK (NOT (functie!='VERKOPER' AND comm IS NOT NULL));
